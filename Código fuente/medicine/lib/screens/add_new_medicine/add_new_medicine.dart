...
class _AddNewMedicineState extends State<AddNewMedicine> {
  ...
  //lista de mediciona por tipos
  final List<MedicineType> medicineTypes = [
    MedicineType(
        "Jarabe", Image.asset("assets/images/syrup.png"), true),
    MedicineType(
        "Píldora", Image.asset("assets/images/pills.png"), false),
    MedicineType(
        "Capsula", Image.asset("assets/images/capsule.png"), false),
    MedicineType(
        "Crema", Image.asset("assets/images/cream.png"), false),
    MedicineType(
        "Gotas", Image.asset("assets/images/drops.png"), false),
    MedicineType(
        "Inyección", Image.asset("assets/images/syringe.png"), false),
  ];
  ...
  Future savePill() async {
    ...
    if (setDate.millisecondsSinceEpoch <=
      ...
      snackbar.showSnack(
          "Revisa la hora y día del medicamento", _scaffoldKey, null);
    } else {
      //create pill object
      Pill pill = Pill(
